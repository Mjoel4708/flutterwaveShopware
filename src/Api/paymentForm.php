...
<form method="POST" action="processPayment.php" id="paymentForm">
    ...
    <input type="hidden" name="title" value="Mike Store"/>
    ...
    <input type="hidden" name="email" value="mjoel4708@gmail.com"/> <!-- Replace the value with your customer email -->
    <input type="hidden" name="firstname" value="Mickey"/>
    <!-- Replace the value with your customer firstname (optional) -->
    <input type="hidden" name="lastname" value="Orwa"/>
    <!-- Replace the value with your customer lastname (optional) -->
    <input type="hidden" name="phonenumber" value="254798184724"/>
    ...
    <input type="hidden" name="ref" value="MICKEY_5a22a7f270abc8879"/>
